...
export function transformApiNavToNavItems(apiNavRights: ApiNavRight[]): NavItem[] {
  // Sort by sort_order
  const sorted = [...apiNavRights].sort((a, b) => 
    a.nav_menu.sort_order - b.nav_menu.sort_order
  );
